# Digg AI Printed CLI Agent Guide

This directory is a generated `digg-ai-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
digg-ai-pp-cli doctor --json
digg-ai-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
digg-ai-pp-cli which "<capability>" --json
digg-ai-pp-cli <command> --help
```
...
```bash
digg-ai-pp-cli <command> --help
digg-ai-pp-cli <command> --dry-run --agent
```
