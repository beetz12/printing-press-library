...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "digg-ai-pp-cli",
		Short: `Digg AI news curation CLI — track what researchers boost on X, pivot the feed by endorser, see velocity over time.`,
		Long: `Digg AI news curation CLI — track what researchers boost on X, pivot the feed by endorser, see velocity over time.
...
Health check: run 'digg-ai-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("digg-ai-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'digg-ai-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTopicPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	// Novel commands
	rootCmd.AddCommand(newLatestCmd(flags))
	...
	rootCmd.AddCommand(newCooccurCmd(flags))
	rootCmd.AddCommand(newEndorsersCmd(flags))
