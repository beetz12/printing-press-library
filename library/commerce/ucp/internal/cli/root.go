...
The bundled fixture-merchant is available behind the hidden 'mock serve' subcommand for CI/conformance use.`,
	...
	rootCmd.SetVersionTemplate("ucp-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ucp-pp-cli profile list')")
	...
	rootCmd.AddCommand(newMockCmd(flags))
	rootCmd.AddCommand(newMerchantsCmd(flags))
